...
class TranslationModel(nn.Module):
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model=512,
        ...
        self.my_transformer = MyTransformer(d_model=d_model, nhead=nhead,num_encoder_layers=num_encoder_layers,
    ...
    def forward(self, src=None, tgt=None, src_mask=None, tgt_mask=None,
        ...
        # [tgt_len, batch_size, embed_dim]
        logits = self.classification(outs)
        # [tgt_len, batch_size, tgt_vcab_size]
        return logits
